    ...
    <footer className="bg-dark-300 py-12 border-t border-neutral-800">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mt-4 text-neutral-400 text-sm">
              Web developer specializing in modern, minimalist designs with a focus on performance and user experience.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#projects" className="text-neutral-400 hover:text-white transition-colors">Projects</a></li>
              <li><a href="#skills" className="text-neutral-400 hover:text-white transition-colors">Skills</a></li>
              <li><a href="#hobbies" className="text-neutral-400 hover:text-white transition-colors">Hobbies</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://www.instagram.com/karllegson" 
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-white transition-colors"
        ...
        <div className="mt-8 pt-8 border-t border-neutral-800 text-center text-neutral-500 text-sm">
          <p>&copy; {currentYear} Karl Legson. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
